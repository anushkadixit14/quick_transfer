...
public class TransferMapper {
	...
	public TransferResponse toResponse(MoneyTransfer moneyTransfer) {
		return TransferResponse.builder()
				.transactionId(moneyTransfer.getTransactionId())
				.referenceNumber(moneyTransfer.getReferenceNumber())
				.customerId(moneyTransfer.getCustomer().getCustomerId())
				.receiverName(moneyTransfer.getReceiverName())
				.destinationCountry(moneyTransfer.getDestinationCountry())
				.transferAmount(moneyTransfer.getTransferAmount())
				.currency(moneyTransfer.getCurrency())
				.status(moneyTransfer.getTransferStatus().name())
