...
public class MoneyTransferServiceTest {
	...
	void createTransfer_ShouldCreateTransferSuccessfully() {
		...
		TransferResponse response = TransferResponse.builder().transactionId(1L).build();
	...
	@Test
	void createTransfer_ShouldThrowException_WhenCustomerNotFound() {
		...
		assertThrows(ResourceNotFoundException.class, () -> moneyTransferService.createTransfer(request));
	}

	@Test
	void createTransfer_ShouldThrowException_WhenCustomerInactive() {
		...
		assertThrows(BussinessValidationException.class, () -> moneyTransferService.createTransfer(request));
	}
	...
	void getTransferById_ShouldThrowException() {
		...
		assertThrows(ResourceNotFoundException.class, () -> moneyTransferService.getTransferById(100L));
	}

	@Test
	void updateStatus_ShouldAllowCreatedToValidated() {
		...
		assertDoesNotThrow(() -> moneyTransferService.updateTransferStatus(1L, request));
	}
